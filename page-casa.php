    ...
    <div class="container">
        ...
        <div class="social">
            ...
            <div class="social-item" id="larimavila">
                ...
                <a class="social-item-link link_click link_click_Guit"  id="link_click_Guit_Instagram" onclick="_gaq.push(['_trackEvent', 'Guit', 'Enlace Saliente', 'Facebook']);"    href="https://www.instagram.com/guitshop/" target="_blank"><img class="casa_image" src="<?=home_url();?>/wp-content/themes/ldm/landing/casa/Instagram03.jpg" alt="guit shop"> Guit - Instagram</a>
                <a class="social-item-link link_click link_click_Guit "  id="link_click_Guit_Facebook" onclick="_gaq.push(['_trackEvent', 'Guit', 'Enlace Saliente', 'Instagram']);"   href="https://web.facebook.com/guitshop?_rdc=1&_rdr" target="_blank"><img class="casa_image" src="<?=home_url();?>/wp-content/themes/ldm/landing/casa/Facebook03.jpg" alt="guit shop"> Guit - Facebook</a>
                <a class="social-item-link link_click link_click_Guit"  id="link_click_Guit_Whatsapp"  onclick="_gaq.push(['_trackEvent', 'Guit', 'Enlace Saliente', 'Whatsapp']);"   href="https://api.whatsapp.com/send?phone=+51999669966&text=Hola" target="_blank"><img class="casa_image" src="<?=home_url();?>/wp-content/themes/ldm/landing/casa/Telefono03.jpg" alt="guit shop"> Guit - Whatsapp</a>
            </div>
        </div>
